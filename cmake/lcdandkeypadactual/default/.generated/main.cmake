...
add_executable(lcdandkeypadactual_default_image_2l_KzTBK ${lcdandkeypadactual_default_library_list})

set_target_properties(lcdandkeypadactual_default_image_2l_KzTBK PROPERTIES
    OUTPUT_NAME "default"
    SUFFIX ".elf"
    ADDITIONAL_CLEAN_FILES "${output_extensions}"
    RUNTIME_OUTPUT_DIRECTORY "${lcdandkeypadactual_default_output_dir}")
target_link_libraries(lcdandkeypadactual_default_image_2l_KzTBK PRIVATE ${lcdandkeypadactual_default_default_XC8_FILE_TYPE_link})

# Add the link options from the rule file.
lcdandkeypadactual_default_link_rule( lcdandkeypadactual_default_image_2l_KzTBK)
