...
add_executable(testmpx_default_image_6VBe6SAz ${testmpx_default_library_list})

set_target_properties(testmpx_default_image_6VBe6SAz PROPERTIES
    OUTPUT_NAME "default-production"
    SUFFIX ".elf"
    ADDITIONAL_CLEAN_FILES "${output_extensions}"
    RUNTIME_OUTPUT_DIRECTORY "${testmpx_default_output_dir}")
target_link_libraries(testmpx_default_image_6VBe6SAz PRIVATE ${testmpx_default_default_XC8_FILE_TYPE_link})

# Add the link options from the rule file.
testmpx_default_link_rule( testmpx_default_image_6VBe6SAz)
